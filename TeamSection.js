      ...
      <div className="container mx-auto px-4">
        ...
        <div className="team-grid">
          {members.map((member, index) => (
            ...
            <img className="w-full rounded-lg shadow-lg" src={member.image} alt={member.name} />
            <div className="overlay">
              <div className="text-center">
                <h3 className="text-xl font-bold">{member.name}</h3>
                <p className="text-sm">{member.role}</p>
                <div className="mt-4 flex justify-center space-x-4">
                  <a href={member.social.twitter} className="text-white" target="_blank" rel="noopener noreferrer">
                    <FaGithub size={24} />
                  </a>
                  <a href={member.social.linkedin} className="text-white" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin size={24} />
                  </a>
                </div>
              </div>
