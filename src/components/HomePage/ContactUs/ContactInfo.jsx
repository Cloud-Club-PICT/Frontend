  ...
  return (
    <div className="flex-1 p-4 bg-gradient-to-r from-primary-100 to-primary-300 text-white rounded-lg flex flex-col items-center justify-center space-y-4">
      ...
      <div className="flex space-x-4 mt-4">
        <a href="https://www.linkedin.com/posts/aws-cloud-club-pict_aws-cloud-club-at-pict-meetup-activity-7185691896281788416-WNAL"><LinkedInIcon fontSize="large"  target="_blank" /></a>
        <a href="https://www.instagram.com/awscloudclubs.pict/" target="_blank" ><InstagramIcon fontSize="large" /></a>
        <a href="https://www.meetup.com/aws-cloud-club-at-pict" target="_blank"><MeetupIcon fontSize="large" /></a>
      </div>
    </div>
  );
}
