    ...
    return (
        <>
            <div>
                ...
                <div className=" text-white text-3xl md:text-5xl flex justify-center pt-10 md:h-1/6  " style={{ gridArea: '' }}>
                ...
                <div className=" grid-cols-2 flex justify-around w-full  text-white"
