...
const LaunchpageMd = () => {
    ...
    return (
        <>
            <div
                className="relative h-screen w-screen bg-cover bg-center bg-no-repeat text-white font-sans flex items-end justify-center overflow-x-hidden"
            ...
            >
                ...
                <div className="absolute left-28 top-2/3 hidden lg:block">
                    <button
                ...
                <div className="absolute top-2/3 translate-y-20 lg:hidden">
                    <button
                        onClick={() => navigate("/Intro")}
                ...
                <div className="absolute top-0 left-1/4">
                    <MouseParallax strength={0.07}>
                        <div className="absolute w-2 h-2 bg-gradient-to-b from-[#DD734F] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out">
                            <div
                                className={`transform -translate-x-2/4 -translate-y-2/4 ${mounted
